...
ast.Tex.defineVisitor("extractSubscipts",{
    ...
    CURLY:function(x){
        ...
        x.forEach(function(e){
            y.push(e.extractSubscipts());
        });
        return y.join('');},
    DECLh:function(){return [];},
    DQ:function(){return [];},
    DQN:function(){return [];},
    FQ:function(){return [];},
    FQN:function(){return [];},
    FUN1:function(){return [];},
    FUN1hf:function(){return [];},
    FUN1hl:function(){return [];},
    FUN1nb:function(){return [];},
    FUN2:function(){return [];},
    FUN2h:function(){return [];},
    FUN2nb:function(){return [];},
    FUN2sq:function(){return [];},
    INFIX:function(){return [];},
    INFIXh:function(){return [];},
    LR:function(){return [];},
    MATRIX:function(){return [];},
    UQ:function(){return [];},
    UQN:function(){return [];}
});
